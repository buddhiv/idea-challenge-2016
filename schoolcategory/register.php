...
<html lang="en">
<head>
    <title>Register | IDEA Challenge 2K16</title>
        ...
        <div id="inner-content" class="container">
            <div id="about">
                <div class="row-fluid">
                    ...
                    if ($dom <= 30) {
                        ?>
                        <h3 style="margin-top: 30px; color: #7DA817; margin-bottom: 30px">
                            Registrations close on 13th May 2016. (<?php echo(13 - $dom); ?> days left)
                        </h3>
